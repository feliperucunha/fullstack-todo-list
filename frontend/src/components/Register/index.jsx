...
import authPng from '../../assets/img1.png';
        ...
        <div className='max-w-screen-xl m-0 sm:m-5 bg-white shadow sm:rounded-lg flex justify-center flex-1'>
            ...
            <div className='mt-12 flex flex-col items-center'>
              ...
              >
                ...
                <div className='my-12 border-b text-center'>
                  <div className='leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2'>
                    Ou entre rapidamente com uma rede social
                  </div>
                </div>
             ...
             bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5'
                  ...
                  >
                    ...
                    <span className='ml-4'>Entrar</span>
                  </a>
                </div>
              </form>
            </div>
          ...
          <div className='flex-1 bg-indigo-100 text-center hidden lg:flex'>
            <div
              ...
              style={{ backgroundImage: `url(${authPng})` }}
            ></div>
          </div>
        </div>
